...
const AdminLayout = ({ children }) => {
  ...
  const navigation = [
    ...
    { name: 'Hero Slider', href: '/admin/slider', icon: '🖼️' },
    { name: 'Announcements', href: '/admin/announcements', icon: '📢' },
    { name: 'PM Quotes', href: '/admin/pm-quotes', icon: '💬' },
    { name: 'About Sections', href: '/admin/about', icon: 'ℹ️' },
    { name: 'Offerings', href: '/admin/offerings', icon: '🎯' },
