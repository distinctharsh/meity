...
var offlineNoticeText = (currentScript && currentScript.getAttribute && currentScript.getAttribute("offline-text")) || "Translation unavailable in offline mode";
var onlineRestoredText = (currentScript && currentScript.getAttribute && currentScript.getAttribute("online-text")) || "Translation back online";
var isOfflineMode = typeof navigator !== "undefined" ? navigator.onLine === false : false;
var wrapperButton = null;
...
if (pluginContainer) {
  ...
  console.warn("Bhashini plugin container not found");
}
